  ...
  return (
    <footer id="footer" className="bg-black text-white py-16 px-8">
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:pr-6">
          <a href="/" className="logo">
            <Image src="/PowerPlay.png" alt="RoochCasino logo" width={172} height={15} />
          </a>
          <p className="mt-9 text-m text-ultra-white/70">
            RoochCasino is your ultimate destination for Web3 gaming. Experience transparency, fairness,
      ...
      <div className="mt-6 text-sm text-center text-white/60">
        © {new Date().getFullYear()} RoochCasino. All rights reserved. RoochCasino is committed to providing
